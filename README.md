...
- STM32F401CEU       (Target series -> STM32F401 | Target version -> CEU) (не тестировалось)
...
**LB1_Base** - основное задание данной лабораторной работы

**LB1_DLS** - дополнительное задание данной лабораторной работы
<br/>
